...
public class URLs {
    ...
    //lcoal address
    //public static String MAIN_URL = "http://192.168.0.107:8080/bsn/";
    ...
    public static String GET_POST = MAIN_URL+"getUserPost";
    ...
    public static String SEARCH_POST= MAIN_URL+"searchPosts";
