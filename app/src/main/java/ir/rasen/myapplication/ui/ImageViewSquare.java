...
public class ImageViewSquare extends ImageView {//implements View.OnTouchListener {

	//boolean exed=true;
	//float startY=0, befY=0;

public ImageViewSquare(final Context context) {
    super(context);
    //init(context, null);
}

public ImageViewSquare(final Context context, final AttributeSet attrs) {
    super(context, attrs);
    //init(context, attrs);
}
